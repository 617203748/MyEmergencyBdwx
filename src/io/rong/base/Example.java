...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		...
		List<String> messagePublishPrivateToUserId = new ArrayList<String>();
		messagePublishPrivateToUserId.add("userId2");
		messagePublishPrivateToUserId.add("userid3");
		messagePublishPrivateToUserId.add("userId4");

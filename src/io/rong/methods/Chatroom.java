...
public class Chatroom {
	 ...
	 * 
	 * @param chatRoomInfo
	 *            :id:要创建的聊天室的id；name:要创建的聊天室的name。（必传）
	 * 
	 ...
	 * 
	 * @param userId
	 *            :要加入聊天室的用户 Id，可提交多个，最多不超过 50 个。（必传）
	 * @param chatroomId
	 *            :要加入的聊天室 Id。（必传）
	 * 
	 * @return CodeSuccessReslut
	 ...
	 *            :要查询的聊天室 ID。（必传）
	 * @param count
	 *            :要获取的聊天室成员数，上限为 500 ，超过 500 时最多返回 500 个成员。（必传）
	 * @param order
	 *            :加入聊天室的先后顺序， 1 为加入时间正序， 2 为加入时间倒序。（必传）
	 * 
	 ...
	 * 
	 * @param objectName
	 *            :低优先级的消息类型，每次最多提交 5 个，设置的消息类型最多不超过 20 个。（必传）
	 * 
	 * @return CodeSuccessReslut
	 **/
	 ...
	 * 
	 * @param chatroomId
	 *            :聊天室中用户 Id，可提交多个，聊天室中白名单用户最多不超过 5 个。（必传）
	 * @param userId
	 *            :聊天室 Id。（必传）
	 * 
	 * @return CodeSuccessReslut
